var CacheParser = require('./CacheParser');
...
var Loader = (function() {
  ...
  var callbacks = {
    ...
    onLoad: function(source, callbackSuccess, callbackError, xhrProgressEvent) {
      ...
      var fileInfo = CacheParser.parse(xhr.getAllResponseHeaders());
  ...
  function load(source, type, callbackSuccess, callbackFail) {
    ...
    if(NetworkMonitor.isOnline()) {
      ...
      NetworkMonitor.registerForOffline(
        abort.bind(this,
          xhr,
          source,
          callbackSuccess,
      ...
      NetworkMonitor.registerForOnline(
        load.bind(this,
          source,
          callbackSuccess,
          callbackFail));
